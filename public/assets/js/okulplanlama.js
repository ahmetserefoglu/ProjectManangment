...
var app = angular.module('okulPlanlamaRecords', ['angularUtils.directives.dirPagination','datatables']
    , ['$httpProvider', function ($httpProvider) {
        $httpProvider.defaults.headers.post['X-CSRF-TOKEN'] = $('meta[name=csrf-token]').attr('content');
    }]);

app.controller('okulPlanlamaController', ['$scope', '$http','$timeout', function ($scope, $http,$timeout) {
    ...
    $scope.ogretmenlerdetay=function (id) {
        ...
        $("#frmOgrencilerDetayList").css({"display":"none"});
        $("#frmVelilerDetayList").css({"display":"none"});
        $("#frmSubelerDetayList").css({"display":"none"});
    ...
    $scope.ogrencilerdetay=function (id) {
        ...
        $("#frmOgretmenlerDetayList").css({"display":"none"});
        $("#frmVelilerDetayList").css({"display":"none"});
        $("#frmSubelerDetayList").css({"display":"none"});
        $http.get('/api/v1/okulplanlama/'+id)
        .then(function success(e) {
