...
<div class="row">
  ...
  <div class="box-body">
    ...
    <div class="panel-body"> 
      <form class="form-horizontal" role="form" method="POST" action="{{ route('projeler.projedurumekle',['id' => $projeler->id]) }}">
        {!! csrf_field() !!}
        <div class="form-group row">
          <label for="title" class="col-md-2 control-label">Proje Detay Basligi</label>
          <div class="col-md-10">
            <input type="text" class="form-control" name="proje_detay_baslik" value="{{ old('proje_detay_baslik') }}" >
              @if ($errors->has('title'))
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
            <textarea id="proje_detay" cols="10" rows="10" class="form-control{{ $errors->has('proje_detay') ? ' is-invalid' : '' }}" name="proje_detay" value="{{ old('proje_detay') }}" required autofocus></textarea>
        ...
        <div class="form-group row mb-0">
          <div class="col-sm-6 col-md-offset-2">
            ...
            <a class="btn btn-primary" href="/projeler/detay/{{$projeler->id}}">Geri Al</a>
          </div>
        </div>
      </form>
    </div>
