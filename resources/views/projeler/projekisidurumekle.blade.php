  ...
  <div class="box-body">
    <div class="col-md-8" style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;">
      ...
      <div class="panel-body"> 
        <form class="form-horizontal" role="form" method="POST" action="{{ route('projeler.projekisidurumekle',['id' => $projeler->id]) }}">
          {!! csrf_field() !!}
        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
            <select id="durum" cols="10" rows="10" class="form-control{{ $errors->has('durum') ? ' is-invalid' : '' }}" name="durum" value="{{ old('durum') }}">
