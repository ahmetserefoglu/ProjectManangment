  ...
  <div class="box-body">
    <div class="col-md-8" style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;">
        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" method="POST" action="{{ route('gorevler.store') }}">
                {{ csrf_field() }}
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <div class="form-group{{ $errors->has('progress') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-10">
                            <input id="progress" class="form-control" type="number" name="progress" value="{{ old('progress') }}" required autofocus value="4.5" data-decimals="2" min="0" max="1" step="0.1"/>
                    ...
                    <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-10">
                            <input id="" type="date" class="form-control" name="start_date" value="{{ old('start_date') }}" required autofocus>
                    ...
                    <div class="form-group{{ $errors->has('parent') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-10">
                            <input id="parent" type="text" class="form-control" name="parent" value="{{ old('parent') }}" required autofocus>
                    ...
                    <div class="form-group{{ $errors->has('sortorder') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-10">
                            <input id="sortorder" type="text" class="form-control" name="sortorder" value="{{ old('sortorder') }}" required autofocus>
