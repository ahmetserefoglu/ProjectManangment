 ...
 <div class="row">
  ...
  <div class="box-body">
        <div class="col-md-8" style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;">
            ...
            <h2 class="col-md-10 col-md-offset-4">Yeni Firma Ekleme</h2>
            <div class="panel-body">                
                <form class="form-horizontal" role="form" method="POST" action="{{ route('firmalar.store') }}">
                    {{ csrf_field() }}
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="FirmaAdi" type="text" class="form-control" name="FirmaAdi" value="{{ old('FirmaAdi') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('YetkiliAdi') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="YetkiliAdi" type="text" class="form-control" name="YetkiliAdi" value="{{ old('YetkiliAdi') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('YetkiliSoyadi') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="YetkiliSoyadi" type="text" class="form-control" name="YetkiliSoyadi" value="{{ old('YetkiliSoyadi') }}" required autofocus>
